...
- проверка восстановления backup на чистом локальном хранилище;
- предупреждение в продукте, что local-first данные живут внутри браузера/PWA или APK;
- сценарий удаления приложения: пользователь сначала делает backup, затем восстанавливает JSON после новой установки;
...
- mobile smoke tests для ширин 360, 390 и 430 px, включая экран import preview после восстановления;
...
- пройти ручной export/import smoke перед переходом к Capacitor.
...
- проверить, что удаление APK удаляет локальные данные, а backup JSON восстанавливает состояние после новой установки.

### Stage 3: Android APK debug build

- собрать debug APK;
- установить на телефон;
- проверить onboarding, Today, Body, Money, Prompt Center, Weekly Review и backup/import.
