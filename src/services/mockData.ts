...
export const mockPromptCards: PromptCard[] = [
  ...
  },
  {
    ...
    description: 'Найти закономерности по телу, фокусу и восстановлению за последние 7 дней.',
    promptHint:
      'Разбери последние 7 дней: тело, похудение, фокус, восстановление и один главный риск следующей недели.',
    preferredFormat: 'Короткий недельный обзор, закономерности и один реалистичный следующий шаг',
  },
  {
    id: 'relationships',
